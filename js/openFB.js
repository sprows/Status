var openFB = (function () {
    ...
    console.log('Value of tokenStore: ' + tokenStore);
    ...
    */
    function init(appId, redirectURL, store) {
        ...
        console.log('tokenSTore in Init: ' + tokenStore);
    ...
    */
    function login(scope, success, error) {
        ...
        //loginWindow = window.open('http://www.google.com');
    ...
    */
    function logout() {
        ...
        //                                        openFB.tokenStore['fbtoken'] = undefined;
    }
    ...
    */
    ...
    function apiWithoutPermission(obj) {
        ...
        console.log('apiWithoutPermission: ' + url);
    ...
    */
    ...
    return {
        ...
        apiWithoutPermission: apiWithoutPermission,
